...
Records are structured dicts; ``validrig.qms.render`` turns them into YAML/Markdown.
"""
...
from validrig.models.pack import BatterySpec, Pack
from validrig.models.results import Grade, Pins, RunMeta
from validrig.perturb.expand import expand_battery
from validrig.qms.attestation import (
    CLINICAL_SIGNER_ROLES,
    build_attestation,
    unsigned_signoff,
)
from validrig.qms.baseline import TEMPLATE_SOURCES, TEMPLATE_VERSIONS
