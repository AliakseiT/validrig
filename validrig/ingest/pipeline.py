...
from validrig.ingest.pseudonymize import Pseudonymizer, residual_identifiers
from validrig.models.pack import CaseSchema

#: The exact guarantee `rig ingest` makes. Stated everywhere the pipeline
